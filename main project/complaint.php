...
<input type="checkbox" id="check">
    ...
    <input type="text" class="field" name="ctitle" placeholder="Subject विषय " required><br>
    <textarea placeholder="Enter Your Complaint तक्रार नोंदवा" name="nmsg" class="field" required></textarea><br>
    <button class="btn" name="lcomplaint">Lodge Complaint तक्रार नोंदवा</button>
