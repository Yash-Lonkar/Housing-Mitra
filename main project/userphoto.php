...
<input type="checkbox" id="check">
    ...
    <div class="sidebar">
      ...
      <a href="complaint.php"><i class="fas fa-envelope-open-text"></i><span>Register Complaint तक्रार नोंदवा </span></a>
      <a href="payment.php"><i class="fas fa-file-invoice-dollar"></i><span>Maintenance Payment पेमेंट </span></a>
      <a href="userphoto.php"><i class="fas fa-camera-retro"></i><span>Photo Gallery फोटो </span></a>
