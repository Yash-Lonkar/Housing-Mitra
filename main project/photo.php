...
<input type="checkbox" id="check">
    ...
    <div class="sidebar">
      ...
      <a href="userphoto.php"><i class="fas fa-camera-retro"></i><span> Gallery फोटो गॅलरी  </span></a>
    ...
    <h2 style="text-align: center; margin-bottom: 5px;">PHOTO GALLERY फोटो गॅलरी</h2>
<p style="text-align: center; margin-top: 5px;"><b>आमची सोसायटी आमच्या आठवणी</b></p>
